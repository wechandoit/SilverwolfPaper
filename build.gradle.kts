...
paperweight {
    upstreams.register("aspaper") {
        ...
        patchFile {
            ...
            outputFile = file("silverwolfpaper-server/build.gradle.kts")
            patchFile = file("silverwolfpaper-server/build.gradle.kts.patch")
        }
        patchFile {
            path = "aspaper-api/build.gradle.kts"
            outputFile = file("silverwolfpaper-api/build.gradle.kts")
            patchFile = file("silverwolfpaper-api/build.gradle.kts.patch")
        }
        patchRepo("paperApi") {
            upstreamPath = "paper-api"
            patchesDir = file("silverwolfpaper-api/paper-patches")
            outputDir = file("paper-api")
        }
        patchDir("aspaperApi") {
            upstreamPath = "aspaper-api"
            excludes = listOf("build.gradle.kts", "build.gradle.kts.patch", "paper-patches")
            patchesDir = file("silverwolfpaper-api/aspaper-patches")
